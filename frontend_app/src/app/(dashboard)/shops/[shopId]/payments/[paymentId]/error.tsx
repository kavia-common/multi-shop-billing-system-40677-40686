...
/**
 * PUBLIC_INTERFACE
 * ShopPaymentDetailError
 * @description Error boundary for payment detail page.
 */
export default function ShopPaymentDetailError({
  error,
  reset,
}: {
  ...
  return (
    <div className="p-6">
      <div className="rounded-xl border border-red-200 bg-red-50 p-4 text-red-800">
        <h2 className="font-semibold">Unable to load payment.</h2>
        <button
          type="button"
          onClick={() => reset()}
